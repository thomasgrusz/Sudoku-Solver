...
# display(search(puzzle_1))
    ...
    def post(self):
        ...
        self.write('Include Diagonals (empty = no): ')
        self.write(diag)
        self.write('\n')
        self.write('\n')
        self.write('\n')

        self.write('Puzzle String:  ')
        self.write(puzzle_string)
        self.write('\n')
        self.write('\n')
        self.write('\n')

        self.write('Length of Puzzle String: ')
        self.write(len(puzzle_string))
        self.write('\n')
        self.write('\n')
        self.write('\n')
